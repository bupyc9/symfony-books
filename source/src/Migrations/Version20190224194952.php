 ...
 */
final class Version20190224194952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT NOT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, year INT NOT NULL, pages INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
